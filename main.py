...
numberOfNodes = 0
devs=0
jobs = max(1, os.cpu_count() - 1) # type: ignore
nameList = []
...
def create():
    ...
    check_return_code(acc_status, "Creating all bridge side-int-X and side-ext-X" ) # dont break
